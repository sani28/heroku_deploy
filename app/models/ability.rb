...
class Ability
  ...
  def initialize(user)
    ...
    #DSL -> Domain specific language : Ruby code written in a certain way to look like its it own language
    # but it is still in ruby language
    ...
    #the question is currently the signed in user
